...
%   - First use per chapter: "Long form (SHORT)"
%   - Subsequent uses: "SHORT"
%
% Call \glsresetall[abbreviations] at the start of each chapter (already done
% in the chapter template files) to restart the first-use tracking.
%
% For plurals, add optional arguments:
%   \newabbreviation[longplural={...}, shortplural={...}]{KEY}{SHORT}{Long form}
% =============================================================================
