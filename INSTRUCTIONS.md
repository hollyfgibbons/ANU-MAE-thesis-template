...
3. Open **Menu** (top-left hamburger icon) → **Compiler** → select **pdfLaTeX**
...
The easiest way is to export from Zotero (see `README.md` for full instructions). If adding manually, open `reference_library.bib` and add an entry:
