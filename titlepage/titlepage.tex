...
\begin{center}
    ...
    \begin{tabular}{c @{\hspace{1cm}} c}
        ...
        \begin{minipage}[t]{0.35\textwidth}
            ...
            Mr SUPERVISOR NAME 2\\[1.0cm]
            % Replace the TikZ block below with your placement logo:
            % \includegraphics[height=3.8cm]{titlepage/placement_logo.png}
            \begin{tikzpicture}
              \draw[fill=gray!15, draw=gray!60, rounded corners=2pt]
                (0,0) rectangle (4.2,2.5);
              \node[gray!70, font=\small] at (2.1,1.25) {PLACEMENT LOGO};
            \end{tikzpicture}
        \end{minipage}
    \end{tabular}
