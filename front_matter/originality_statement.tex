...
% =============================================================================
% This is the standard ANU originality declaration. The text below should not
% be changed (it is the official wording required by ANU).
%
...
%   - YOUR FULL NAME
%   - DATE OF SUBMISSION
%   - Word count (if different from 30,000)
%
